...
public class _MapGrid {
	...
	private static _MapGrid instance = new _MapGrid(MyBotModule.Broodwar.mapHeight() * 32, MyBotModule.Broodwar.mapHeight() * 32, Config.MAP_GRID_SIZE);
	
	/// static singleton 객체를 리턴합니다
	public static _MapGrid Instance() {
		return instance;
	}

	public _MapGrid(int mapWidth, int mapHeight, int cellSize)
	{
