...
public class _InformationManager_in_kata {
	private static _InformationManager_in_kata instance = new _InformationManager_in_kata();
	...
	public static _InformationManager_in_kata Instance() {
		return instance;
	}

	public _InformationManager_in_kata() {
