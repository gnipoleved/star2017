...
public class GameCommander_org {
...
//		if ( isToFindError) System.out.print("b");
		...
		for (Unit unit : MyBotModule.Broodwar.enemy().getUnits()) {
			info.updateUnitInfo(unit);
			
			grid.getCell(unit).ourUnits.add(unit);
			grid.getCell(unit).timeLastVisited = MyBotModule.Broodwar.getFrameCount();
