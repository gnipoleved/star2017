...
public class _InformationManager {
	private static _InformationManager instance = new _InformationManager();
	...
	public static _InformationManager Instance() {
		return instance;
	}

	public _InformationManager() {
