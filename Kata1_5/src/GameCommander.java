	...
	public void onFrame()
	{
		...
		try {
			...
			for (Unit unit : MyBotModule.Broodwar.enemy().getUnits()) {
				...
				strategy.updateEnemyUnitInfo(InformationManager.Instance().updateUnitInfo(unit));
			...
			for (Unit unit : MyBotModule.Broodwar.self().getUnits()) {
				//_InformationManager.Instance().updateUnitInfo(unit);
				strategy.updateSelfUnitInfo(InformationManager.Instance().updateUnitInfo(unit));
